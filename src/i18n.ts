...
const enMessages = {
  ...
  noticeDictionaryFileInvalid: "Dictionary file must be JSON, CSV, TSV, txt, or APKG.",
  ...
  settingsDictionaryFileDesc: "Choose a JSON, CSV, TSV, txt, or APKG dictionary file.",
...
const zhMessages: Partial<Record<MessageKey, string>> = {
  ...
  noticeDictionaryFileInvalid: "词典文件必须是 JSON、CSV、TSV、txt 或 APKG。",
  ...
  settingsDictionaryFileDesc: "选择 JSON、CSV、TSV、txt 或 APKG 词典文件。",
